...
password = "maulana20065"
cxn_str = f"mongodb+srv://localhost:{password}@cluster0.ewovbxv.mongodb.net/?retryWrites=true&w=majority"
...
def create_restaurant():
    ...
    return jsonify({"result": "success", "msg": "selamat anda berhasil membuat"})
...
def delete_restaurants():
    ...
    return jsonify({"result": "success", "msg": "selamat anda berhasil menghapus"})
